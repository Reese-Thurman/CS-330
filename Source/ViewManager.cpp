	...
	ShaderManager *pShaderManager)
{
	...
	g_pCamera->Position = glm::vec3(0.0f, 10.0f, 30.0f);
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process switching between ortho and perspective view
 ...
 *  Scroll_Callback()
 *
 *  This method adjusts the speed of the movement
 *  at which the camera travels around the 3D scene
 ***********************************************************/
void ViewManager::Scroll_Callback(GLFWwindow* window, double xoffset, double yoffset)
{
	// Adjust the camera speed based on the user using the scroll wheel
	if (yoffset > 0)
	{
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection == true)
		projection = glm::ortho(-(GLfloat)WINDOW_WIDTH / (GLfloat)WINDOW_HEIGHT * 10.0f, (GLfloat)WINDOW_WIDTH / (GLfloat)WINDOW_HEIGHT * 10.0f, -10.0f, 10.0f, 0.1f, 100.0f);
